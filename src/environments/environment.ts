...
export const environment = {
  ...
  api: {
  	version: '1.2',
  	url: 'http://localhost:8000/api/',//'http://asusuapi.asusu.ng/api/',//'http://ec2-13-59-107-189.us-east-2.compute.amazonaws.com/api/',//'http://localhost:8000/api/', //'http://aix.testapi.asusu.ng/api/',//
